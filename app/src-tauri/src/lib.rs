...
use crate::commands::{
    ...
    cmd_publish_component, cmd_read_wavs_toml, cmd_register_claude_mcp, cmd_remove_service,
    cmd_restart, cmd_resume_service, cmd_get_wavs_url, cmd_save_env_vars, cmd_save_mcp_settings,
