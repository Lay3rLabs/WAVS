...
use crate::commands::{
    ...
    cmd_get_health_status, cmd_get_mcp_status, cmd_get_mnemonic, cmd_get_services, cmd_get_settings,
    cmd_has_mnemonic, cmd_pause_service, cmd_publish_component, cmd_read_wavs_toml,
    cmd_remove_service, cmd_restart, cmd_resume_service, cmd_save_mcp_settings,
