...
## v1.1 BLS Signatures (In Progress)

**Phases:** 5-8 (4 phases, plans TBD)
**Requirements:** 14 (TYPES-01..03, KEYS-01..02, SIGN-01..03, AGG-01..04, INT-01..02)

**Goal:** Add BLS12-381 as a per-service signature scheme alongside secp256k1. Operators sign with BLS keys, the aggregator combines signatures off-chain into a single aggregate, and submissions are verified by poa-middleware BLS service manager contracts.

**Roadmap:** [ROADMAP.md](ROADMAP.md) (phases 5-8)
