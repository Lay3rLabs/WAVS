...
pub unsafe fn _export_handler_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::handler(_rt::string_lift(bytes0));
...
pub trait Guest {
    fn handler(input: _rt::String) -> _rt::String;
}
#[doc(hidden)]
...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    unsafe extern "C" fn _post_return_handler(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_handler::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb51\x01A\x02\x01A\x17\
...
i:http/outgoing-handler@0.2.0\x05\x0e\x01@\x01\x05inputs\0s\x04\0\x07handler\x01\
\x0f\x04\x01\x17component:gecko/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0\
