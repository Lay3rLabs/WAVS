pub type Input = lay3r::avs::task_queue_types::Input;
pub type Output = lay3r::avs::task_queue_types::Output;
pub type Error = lay3r::avs::task_queue_types::Error;
#[doc(hidden)]
...
pub unsafe fn _export_run_task_cabi<T: Guest>(
    ...
    let result1 = T::run_task(lay3r::avs::task_queue_types::Input {
    ...
    match result1 {
        Ok(e) => {
            *ptr2.add(0).cast::<u8>() = (0i32) as u8;
            let lay3r::avs::task_queue_types::Output { response: response3 } = e;
            let vec4 = (response3.into_bytes()).into_boxed_slice();
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6643] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf22\x01A\x02\x01A\x20\
...
i:http/outgoing-handler@0.2.0\x05\x0e\x01B\x06\x01r\x02\x09timestampw\x07request\
s\x04\0\x05input\x03\0\0\x01r\x01\x08responses\x04\0\x06output\x03\0\x02\x01s\x04\
\0\x05error\x03\0\x04\x03\x01\x20lay3r:avs/task-queue-types@0.0.2\x05\x0f\x02\x03\
\0\x06\x05input\x03\0\x05input\x03\0\x10\x02\x03\0\x06\x06output\x03\0\x06output\
\x03\0\x12\x02\x03\0\x06\x05error\x03\0\x05error\x03\0\x14\x01j\x01\x13\x01\x15\x01\
@\x01\x07request\x11\0\x16\x04\0\x08run-task\x01\x17\x04\x01\x1alay3r:avs/task-q\
ueue@0.0.2\x04\0\x0b\x10\x01\0\x0atask-queue\x03\0\0\0G\x09producers\x01\x0cproc\
