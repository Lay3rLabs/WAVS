...
macro_rules! __export_world_cron_job_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "run-cron"]
    unsafe extern "C" fn export_run_cron() -> *mut u8 {
      $($path_to_types)*::_export_run_cron_cabi::<$ty>()
    }
    #[export_name = "cabi_post_run-cron"]
    unsafe extern "C" fn _post_return_run_cron(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_run_cron::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
...
macro_rules! __export_cron_job_impl {
  ...
  $($path_to_types_root)*::__export_world_cron_job_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
