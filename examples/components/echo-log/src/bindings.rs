...
#[doc(hidden)]
macro_rules! __export_world_wavs_eth_log_world_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_wavs_eth_log_world_cabi;
#[repr(align(4))]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_wavs_eth_log_world_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_wavs_eth_log_world_cabi!($ty
        with_types_in $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_wavs_eth_log_world_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:lay3r:avs@0.3.0:wavs-eth-log-world:encoded world"]
#[doc(hidden)]
...
@\x02\x08contract\x02\x03log\x04\0\x06\x04\0\x03run\x01\x07\x04\0\"lay3r:avs/wav\
s-eth-log-world@0.3.0\x04\0\x0b\x18\x01\0\x12wavs-eth-log-world\x03\0\0\0G\x09pr\
