        ...
        pub mod layer_types {
            ...
            impl ::core::fmt::Debug for Address {
                fn fmt(
                    ...
                    match self {
                        Address::Eth(e) => {
                            f.debug_tuple("Address::Eth").field(e).finish()
                        }
                        Address::Cosmos(e) => {
                            f.debug_tuple("Address::Cosmos").field(e).finish()
                        }
                    }
                }
            }
...
=======
#[link_section = "component-type:wit-bindgen:0.36.0:lay3r:avs@0.3.0:layer-chain-event-world:encoded world"]
>>>>>>> caf11e4 (regenerate bindings)
#[doc(hidden)]
