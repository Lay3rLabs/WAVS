...
macro_rules! __export_world_cron_job_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[export_name = "run-cron"] unsafe extern "C" fn
        export_run_cron() -> * mut u8 { $($path_to_types)*:: _export_run_cron_cabi::<$ty
        > () } #[export_name = "cabi_post_run-cron"] unsafe extern "C" fn
        _post_return_run_cron(arg0 : * mut u8,) { $($path_to_types)*::
        __post_return_run_cron::<$ty > (arg0) } };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:lay3r:avs@0.3.0:cron-job:encoded world"]
#[doc(hidden)]
...
\x06output\x03\0\x06output\x03\0\x10\x01@\0\0\x11\x04\0\x08run-cron\x01\x12\x04\0\
\x18lay3r:avs/cron-job@0.3.0\x04\0\x0b\x0e\x01\0\x08cron-job\x03\0\0\0G\x09produ\
