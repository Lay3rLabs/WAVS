    ...
    pub mod wasi {
        ...
        pub mod http {
            ...
            pub mod outgoing_handler {
                ...
                pub type OutgoingRequest = super::super::super::super::wasi::http::types::OutgoingRequest;
                pub type RequestOptions = super::super::super::super::wasi::http::types::RequestOptions;
                ...
                pub unsafe fn _export_handle_cabi<T: Guest>(
                    ...
                    let result0 = T::handle(
                        ...
                        match arg1 {
                            0 => None,
                            1 => {
                                let e = super::super::super::super::wasi::http::types::RequestOptions::from_handle(
                                    arg2 as u32,
                                );
                                Some(e)
                            }
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_http_allow_list_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_http_allow_list_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.30.0:http-allow-list:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6665] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x833\x01A\x02\x01A\x17\
...
i:http/outgoing-handler@0.2.0\x05\x0e\x01B\x0f\x02\x03\x02\x01\x0a\x04\0\x10outg\
oing-request\x03\0\0\x02\x03\x02\x01\x0b\x04\0\x0frequest-options\x03\0\x02\x02\x03\
\x02\x01\x0c\x04\0\x18future-incoming-response\x03\0\x04\x02\x03\x02\x01\x0d\x04\
\0\x0aerror-code\x03\0\x06\x01i\x01\x01i\x03\x01k\x09\x01i\x05\x01j\x01\x0b\x01\x07\
\x01@\x02\x07request\x08\x07options\x0a\0\x0c\x04\0\x06handle\x01\x0d\x04\x01\x20\
wasi:http/outgoing-handler@0.2.0\x05\x0f\x04\x014lay3r-examples:http-allow-list/\
http-allow-list@0.1.0\x04\0\x0b\x15\x01\0\x0fhttp-allow-list\x03\0\0\0G\x09produ\
