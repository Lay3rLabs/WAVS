...
pub type Response = lay3r::avs::hello_world_types::Response;
#[doc(hidden)]
    ...
    match result6 {
        Ok(e) => {
            *ptr7.add(0).cast::<u8>() = (0i32) as u8;
            let lay3r::avs::hello_world_types::Response {
                message_hash: message_hash8,
                task_name: task_name8,
                task_created_block: task_created_block8,
                task_index: task_index8,
            } = e;
            let vec9 = (message_hash8).into_boxed_slice();
            let ptr9 = vec9.as_ptr().cast::<u8>();
            let len9 = vec9.len();
            ::core::mem::forget(vec9);
            *ptr7.add(8).cast::<usize>() = len9;
            *ptr7.add(4).cast::<*mut u8>() = ptr9.cast_mut();
            let vec10 = (task_name8.into_bytes()).into_boxed_slice();
            let ptr10 = vec10.as_ptr().cast::<u8>();
            let len10 = vec10.len();
            ::core::mem::forget(vec10);
            *ptr7.add(16).cast::<usize>() = len10;
            *ptr7.add(12).cast::<*mut u8>() = ptr10.cast_mut();
            *ptr7.add(20).cast::<i32>() = _rt::as_i32(task_created_block8);
            *ptr7.add(24).cast::<i32>() = _rt::as_i32(task_index8);
        }
        Err(e) => {
            ...
            *ptr7.add(8).cast::<usize>() = len11;
            *ptr7.add(4).cast::<*mut u8>() = ptr11.cast_mut();
        }
    };
    ptr7
}
...
pub trait Guest {
    fn process_eth_event(log: EthLog) -> Result<Response, _rt::String>;
}
#[doc(hidden)]
macro_rules! __export_world_hello_world_world_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_hello_world_world_cabi;
#[repr(align(4))]
...
pub mod lay3r {
    ...
    pub mod avs {
        ...
        pub mod hello_world_types {
            ...
            #[derive(Clone)]
            pub struct Response {
                pub message_hash: _rt::Vec<u8>,
                pub task_name: _rt::String,
            ...
            impl ::core::fmt::Debug for Response {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    f.debug_struct("Response")
                        .field("message-hash", &self.message_hash)
                        .field("task-name", &self.task_name)
                        .field("task-created-block", &self.task_created_block)
                        .field("task-index", &self.task_index)
                        .finish()
                }
            }
        }
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_hello_world_world_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_hello_world_world_cabi!($ty
        with_types_in $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_hello_world_world_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.30.0:hello-world-world:encoded world"]
#[doc(hidden)]
...
A\x0b\x01B\x04\x01p}\x01p\0\x01r\x03\x07address\0\x0alog-topics\x01\x08log-data\0\
\x04\0\x07eth-log\x03\0\x02\x03\x01\x1flay3r:avs/eth-event-types@0.3.0\x05\0\x01\
B\x03\x01p}\x01r\x04\x0cmessage-hash\0\x09task-names\x12task-created-blocky\x0at\
ask-indexy\x04\0\x08response\x03\0\x01\x03\x01!lay3r:avs/hello-world-types@0.3.0\
\x05\x01\x02\x03\0\0\x07eth-log\x03\0\x07eth-log\x03\0\x02\x02\x03\0\x01\x08resp\
onse\x03\0\x08response\x03\0\x04\x01j\x01\x05\x01s\x01@\x01\x03log\x03\0\x06\x04\
\0\x11process-eth-event\x01\x07\x04\x01!lay3r:avs/hello-world-world@0.3.0\x04\0\x0b\
\x17\x01\0\x11hello-world-world\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
