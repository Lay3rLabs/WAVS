 ...
 * @author Lay3r Labs
 * @notice Interface for the Wavs service manager (BLS variant)
...
interface IWavsServiceManager {
    ...
    /**
     * @notice Returns the latest operator address associated with a BLS signing key hash.
     * @param keyHash The keccak256 hash of the BLS public key.
     * @return The latest operator address associated with the key, or address(0) if none.
     */
