...
macro_rules! __export_world_task_queue_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "run-task"]
    unsafe extern "C" fn export_run_task(arg0: i64,arg1: *mut u8,arg2: usize,) -> *mut u8 {
      $($path_to_types)*::_export_run_task_cabi::<$ty>(arg0, arg1, arg2)
    }
    #[export_name = "cabi_post_run-task"]
    unsafe extern "C" fn _post_return_run_task(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_run_task::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
...
macro_rules! __export_task_queue_impl {
  ...
  $($path_to_types_root)*::__export_world_task_queue_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
\0\x05error\x03\0\x04\x03\x01\x20lay3r:avs/task-queue-types@0.0.4\x05\x0f\x02\x03\
...
ueue@0.0.4\x04\0\x0b\x10\x01\0\x0atask-queue\x03\0\0\0G\x09producers\x01\x0cproc\
