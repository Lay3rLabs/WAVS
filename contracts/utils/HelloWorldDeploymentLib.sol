...
import {HelloWorldServiceManager} from "../HelloWorldServiceManager.sol";
import {IDelegationManager} from "@eigenlayer/contracts/interfaces/IDelegationManager.sol";
import {Quorum} from "../../lib/eigenlayer-middleware/src/interfaces/IECDSAStakeRegistryEventsAndErrors.sol";
...
library HelloWorldDeploymentLib {
    ...
    function deployContracts(
        ...
        result.helloWorldServiceManager = UpgradeableProxyLib.setUpEmptyProxy(
            proxyAdmin
        );
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ...
            (result.helloWorldServiceManager, 0, quorum)
        );
        ...
        UpgradeableProxyLib.upgrade(
            result.helloWorldServiceManager,
    ...
    function readDeploymentJson(
        ...
        data.helloWorldServiceManager = json.readAddress(
            ".contracts.helloWorldServiceManager"
        );
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(
            UpgradeableProxyLib.getProxyAdmin(data.helloWorldServiceManager)
        );
