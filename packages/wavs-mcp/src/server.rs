        ...
        ServerInfo {
            ...
            instructions: Some(
                "MCP server for the WAVS (WebAssembly-based Actively Validated Services) platform.\n\
                 ...
                 Write tools (need --token): wavs_deploy_service, wavs_pause_service, wavs_resume_service\n\
                 Dev tools (need dev endpoints): wavs_upload_component, wavs_simulate_trigger\n\
