...
use wavs_types::{
    ...
    ServiceMetadataSource, ServiceStatus, Submit, Workflow, WorkflowID,
};
...
fn db_service_store() {
    ...
    let service = Service {
        ...
        metadata_source: ServiceMetadataSource::EthereumServiceManager {
            chain_name: "eth".try_into().unwrap(),
            contract_address: rand_address_eth(),
        },
    };
