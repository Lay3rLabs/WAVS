...
use wavs_types::{ChainName, ComponentID, Service, ServiceConfig, ServiceID, WorkflowID};
...
pub enum WorkflowCommand {
    ...
    Add {
        ...
        /// The ID of the component to use in this workflow
        #[clap(long)]
        component_id: ComponentID,

        /// Optional fuel limit for workflow execution
        #[clap(long)]
        fuel_limit: Option<u64>,
    },
